...
def require_token(
    ...
    if not credentials or not hmac.compare_digest(given, expected):
...
def build_api() -> FastAPI:
    ...
    @app.post(
        ...
        responses={
            ...
            401: _error_doc("Missing or invalid bearer token."),
            413: _error_doc("Document larger than AI_MAX_DOCUMENT_BYTES."),
